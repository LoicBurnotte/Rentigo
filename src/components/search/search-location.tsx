        ...
        {value ? (
          ...
          <div className="flex h-10 items-center gap-2 rounded-lg border border-emerald-300 bg-emerald-50 px-3">
            ...
            <button
              ...
              className="min-w-0 flex-1 truncate text-left text-sm text-gray-800 hover:text-gray-600">
              {value.display}
            </button>
            <button
              type="button"
                  ...
                  return (
                    <button
                      ...
                      <div className="min-w-0">
                        ...
                        {nameParts.length > 1 && (
                          <span className="ml-1 truncate text-xs text-gray-400">{nameParts.slice(1, 3).join(',')}</span>
                        )}
                      </div>
                    </button>
                  )
